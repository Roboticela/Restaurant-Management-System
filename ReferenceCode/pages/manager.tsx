    ...
    const loadCurrency = async () => {
      try {
        ...
        if (response.data?.currency) {
          setCurrencySymbol(response.data.currency || 'USD');
        }
      } catch (error) {
        ...
        <div className="max-w-7xl mx-auto px-4 py-4 sm:py-8">
          ...
          <motion.button
            ...
            className="w-full mb-6 sm:mb-8 bg-gradient-to-r from-teal-500 to-teal-600 text-white 
              rounded-xl py-3 sm:py-4 px-4 sm:px-6 flex items-center justify-center gap-2 shadow-lg 
              hover:shadow-teal-500/50 transition-all duration-300"
          >
            <FaPlus />
